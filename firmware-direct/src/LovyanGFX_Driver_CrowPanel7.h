...
// LovyanGFX panel/touch config for the Elecrow CrowPanel Advance 7.0" HMI
// (ESP32-S3, 800x480 RGB IPS panel, GT911 capacitive touch). Pins are
// taken from Elecrow's own PlatformIO example for this board, same
// wiring TouchWifiProvisioner's CrowPanel7_RollingClock example uses -
// see that repo's LovyanGFX_Driver.h for the reference this was copied
// from unmodified (this is pure board wiring, not app-specific).
